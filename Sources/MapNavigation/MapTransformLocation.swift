...
public class MapTransformLocation: NSObject {
...
extension MapTransformLocation{
     ...
     */
    public func wgs84ToGcj02(location:CLLocationCoordinate2D) ->(CLLocationCoordinate2D){
     ...
     */
    public func gcj02ToWgs84(location:CLLocationCoordinate2D) ->(CLLocationCoordinate2D){
     ...
     *  @return 百度地理坐标（BD-09)
     */
    public func wgs84ToBd09(location:CLLocationCoordinate2D) ->(CLLocationCoordinate2D){
     ...
     *  @return 百度地理坐标（BD-09)
     */
    public func gcj02ToBd09(location:CLLocationCoordinate2D) ->(CLLocationCoordinate2D){
     ...
     *  @return 中国国测局地理坐标（GCJ-02）<火星坐标>
     */
    public func bd09ToGcj02(location:CLLocationCoordinate2D) ->(CLLocationCoordinate2D){
     ...
     *  @return 世界标准地理坐标（WGS-84）
     */
    public func bd09ToWgs84(location:CLLocationCoordinate2D) ->(CLLocationCoordinate2D){
