...
public class PHAssetTool: NSObject {
  
  @objc class public func PHAssetToImageSingle(asset:PHAsset) -> UIImage{
    var image = UIImage()
  ...
  @objc public class func PHAssetToImageList(assetList:[PHAsset]) -> [UIImage]{
