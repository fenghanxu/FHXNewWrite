...
extension NameSpace where Base == UILabel {
    ...
    /**标题颜色**/
    @discardableResult
    public func LabelColor(color: UIColor) -> Self {
        base.tintColor = color
        return self
    }
    /**背景颜色**/
    @discardableResult
    public func LabelBackgroungColor(color: UIColor) -> Self {
        base.backgroundColor = color
        return self
    }
    /**文字大小**/
    @discardableResult
    public func LabelFont(font: UIFont) -> Self{
        base.font = font
        return self
    }
    /**标题内容**/
    @discardableResult
    public func LabelTitle(title: String) -> Self {
        base.text = title
        return self
    }
    /**对齐方法**/
    @discardableResult
    public func LabelTextAlignment(textAlignment: NSTextAlignment) -> Self {
    ...
    /**对文字过长时的省略方式**/
    @discardableResult
    public func LabelLineBreakMode(mode: NSLineBreakMode) -> Self {
        /*
    ...
    /**限制Label的行数**/
    @discardableResult
    public func LabelNumberOfLines(count: Int) -> Self {
    ...
    /**文字大小自适应标签宽度**/
    @discardableResult
    public func LabelAdjustsFontSizeToFitWidth(state: Bool) -> Self {
